             ...
             <div className="headerBackground">
                 <div className="bg-text">
                      <div className="NameText">
                         <Typography style={{fontSize: 60 , fontWeight: 800,  marginTop: 5, marginLeft: -30, textAlign: 'left', color: 'var(--text-primary)', fontWeight: 'bold'}}>Casey Overton</Typography>
                         <Typography style={{fontSize: 30 ,fontWeight: 800,  marginLeft: -20, textAlign: 'left'}}>Full Stack/Front End Developer</Typography>
